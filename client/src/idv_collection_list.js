...
function IndividualCollectionList({}) {
  ...
  return (
                    ...
                    <div className="card idv-collection-card">
                      ...
                      <div className='card-header align-items-center border-0 mt-4'>
                        <h3 className='card-title align-items-start flex-column'>
                          ...
                          <span className='fw-bold fs-2'>{selectedCollection?.name}</span>
                        </h3>
                      </div>
                      {/* end header */}
    ...
    {/* <JourneyModal show={show} handleClose={handleClose} books={books} setBooks={setBooks}  user={user} formatDate={formatDate}/> */}
...
export default IndividualCollectionList